...
training_set = train_datagen.flow_from_directory('C:/Users/Madhuri/AppData)
print(labels)


classifier.fit_generator(training_set,
                         steps_per_epoch = 20,/Local/Programs/Python/Python38/Tomato_Leaf_Disease_Prediction/Dataset/train', # relative path from working directoy
                                                 target_size = (128, 128),
